...
<template>
  ...
  >
    ...
    <span
      class="w-1/2 bg-primary-black h-0.5 absolute z-10"
      style="height: 300%; left: 75%; transform: rotate(45deg)"
    ></span>
    <img src="../assets/images/arrowright.svg" alt="arrow right" class="w-4 z-20" />
  </button>
</template>
